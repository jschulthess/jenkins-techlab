pipeline {
    ...
    post {
        success {
            ...
            emailext body: 'Build success jenkins-techlab lab-10.3', recipientProviders: [[$class: 'DevelopersRecipientProvider'], [$class: 'RequesterRecipientProvider']], subject: 'Success', to: 'schulthess@puzzle.ch'
        }
        unstable {
