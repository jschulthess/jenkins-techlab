...
pipeline {
    ...
    post {
        always {
            //notifyPuzzleChat()
            emailext body: 'Build success jenkins-techlab lab-17.2', recipientProviders: [[$class: 'DevelopersRecipientProvider'], [$class: 'RequesterRecipientProvider']], subject: 'Build Finished', to: 'schulthess@puzzle.ch'
        }
    }
}
